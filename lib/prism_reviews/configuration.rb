...
module PrismReviews
  class Configuration
    ...
    attr_reader :github_org, :expertise_tags, :reviewers, :exclude, :notifications, :state_repo

    def self.load(path: DEFAULT_PATH)
      Loader.call(path:)
    end

    def initialize(github_org:, expertise_tags:, reviewers:, exclude: [], notifications: nil, state_repo: nil)
